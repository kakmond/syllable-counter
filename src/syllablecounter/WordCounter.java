...
/**
 * A WordCounter class that count syllables in a String.
 * 
...
public class WordCounter {
	...
	abstract class State {
		...
		/**
		 * for check in each character that has a vowel or letter or non-word or
		...
		/**
		 * to perform an action in each state.
		 */
